...
public final class OMRGraderProcess {
    ...
    public Exam executeExamProcessing(Exam onlyLogosTemplate,
            ...
            String imageProcessedName, String imageBlackWhiteName) throws OMRGraderImageException {
        try {
            ...
            throw new OMRGraderImageException(
                    "Error while the application was trying to analyzing and processing the Image.",
                    e);
        }
    }
